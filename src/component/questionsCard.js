...
// import { Card, CardContent, Typography, Box, IconButton, Button, Dialog, DialogActions, DialogContent, DialogContentText } from '@mui/material';
...
//                         {text} {/* Use the question text or another piece of text */}
//                     </DialogContentText>
//                 </DialogContent>
//                 <DialogActions sx={{ justifyContent: 'flex-start' }}> {/* Align to the left */}
//                     <Button onClick={handleClose} sx={{ color: '#ffffff', fontSize:'10px' }}>
//                         Close ×
//                     </Button>
//                 </DialogActions>
//             </Dialog>
...
const QuestionsCard = ({ question, likes, answers }) => {
  const [open, setOpen] = useState(false);
